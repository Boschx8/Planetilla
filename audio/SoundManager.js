...
export class SoundManager {
    ...
    scheduleLoop(t0) {
        ...
        for (const [b, f] of bass)
            play(f, t0 + b * beat, beat * 1.6, 'triangle', 0.20);
        ...
        for (const [b, freqs] of pads)
            for (const f of freqs)
                play(f, t0 + b * beat, beat * 7.5, 'sine', 0.038);
        ...
        for (const [b, f] of mel)
            play(f, t0 + b * beat, beat * 1.85, 'triangle', 0.055);
